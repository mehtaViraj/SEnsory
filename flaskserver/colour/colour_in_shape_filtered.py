...
import colour.colour_ranger as labeler
import random
...
class CameraHandler:
    ...
    def save_picture(self):
        big_frame = self.vs.read()
        path = '/home/pi/sensory/SEnsory/flaskserver/movement/saved_images/{}.jpg'.format(random.randint(1, 10000))
...
if __name__ == '__main__':
    cam = CameraHandler("192.168.148.82")
